namespace Assets.Scripts.Util
{
    public class Enums
    {
        ...
        public enum CardTypes { SwordVert, SwordHori, WideSword, NaginataVert, NaginataHori, HammerVert, HammerHori, ThrowLight, ThrowMid, Shoot, ChiAttack, ChiStationary, Error, Fan, Kanobo, Tanto, Wakizashi, Tonfa, BoStaff };
